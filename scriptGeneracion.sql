...
CREATE TABLE IF NOT EXISTS SZ_003_Parents(
    SZ_003_Id INT PRIMARY KEY AUTO_INCREMENT,
    ...
    SZ_003_Nick VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS SZ_002_Students(
    SZ_002_Id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS SZ_204_Students_Emblems(
    SZ_204_Id INT PRIMARY KEY AUTO_INCREMENT,
    SZ_204_Students_Id INT NOT NULL,
    SZ_204_Emblems_Id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS SZ_203_Students_Parents(
    SZ_203_Id INT PRIMARY KEY AUTO_INCREMENT,
    SZ_203_Students_Id INT NOT NULL,
    SZ_203_Parents_Id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS SZ_007_School_Managers(
    SZ_007_Id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS SZ_006_Schools(
    ...
    SZ_006_School_Manager_Id INT NOT NULL,
    SZ_006_Deleted TINYINT DEFAULT(0),
    FOREIGN KEY(SZ_006_School_Manager_Id)
        REFERENCES SZ_007_School_Managers(SZ_007_Id)
);
CREATE TABLE IF NOT EXISTS SZ_008_Teachers(
    SZ_008_Id INT PRIMARY KEY AUTO_INCREMENT,
    ...
    SZ_008_Nick VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS SZ_102_Groups_Students(
    SZ_102_Id INT PRIMARY KEY AUTO_INCREMENT,
    SZ_102_Groups_Id INT NOT NULL,
    SZ_102_Students_Id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS SZ_009_Activities(
    SZ_009_Id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS SZ_109_Groups_Activities(
    SZ_109_Id INT PRIMARY KEY AUTO_INCREMENT,
    SZ_109_Groups_Id INT NOT NULL,
    SZ_109_Activities_Id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS SZ_8014_Teachers_Teachers_Skins(
    SZ_8014_Id INT PRIMARY KEY AUTO_INCREMENT,
    SZ_8014_Teachers_Id    INT NOT NULL,
    SZ_8014_Teachers_Skins_Id    INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS SZ_011_Posts(
    ...
    SZ_011_Teacher_Id INT NOT NULL,
    SZ_011_Threads_Id INT NOT NULL,
